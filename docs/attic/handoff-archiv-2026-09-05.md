# Handoff-Archiv 2026-09-05 — zwoelf Abschnitte ohne lebenden Leser

Aus `HANDOFF.md` ausgelagert am 2026-09-05 01:5x (Controller Slot 3, Owner-Frage „warum ist das
Handoff so gigantisch"): die Datei trug 16 gestapelte Abschnitte von 6 Prinzipalen (160 KB), weil
jede Session prependet und der Succession-Brief nur „den obersten Abschnitt" liest — niemand
raeumt. Hier liegen die zwoelf Abschnitte abgeschlossener Programs (Generalsanierung ×4), aelterer
Controller-Sessions (×4), der aelteren MAIN-Generationen (66499a03 Slot 10, Fleet-Betrieb Slot 3
und Slot 7) und der stale gebundenen Game-Maker-v2-MAIN. Unveraendert, Reihenfolge wie in der
Quelle (juengste zuerst). Wer einen davon braucht: `git log -S'<Ueberschrift>' -- HANDOFF.md`
zeigt den Commit, aus dem er stammt.
