...
- **pi, einfachste Anbindung:** Pane und Paste bleiben. Modell per `/model zai/<id>` und Effort per
  ...
  plus eine Katalogzeile für glm-5.3-flash. Cache-Zähler: Zeitstempel der neuesten
