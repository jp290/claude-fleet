...
## 2. Versionsbefund: kleine Pastes sind seit 2.1.280 nicht mehr gerahmt
...
Der K1-Inbox-Hinweis (215 B, 2.1.278) kam gerahmt an. Unter 2.1.281 kommt derselbe kurze Text als
eigener Text an (Probe B unten). Das Problem liegt heute also bei den GROSSEN Zustellungen:
Gruendungs- und Nachfolge-Briefe sowie lange Nachrichten.
...
## 5. Was gebaut ist, was offen bleibt
...
Offen: der Wirkungsnachweis an einer echten Claude-Pane je Pfad `/send`, Nachfolge-Brief und
Inbox-Hinweis (0/3 Ablehnungen, Negativprobe mit zitiertem Owner-Satz, Land-Anweisung prueft
Promotion). Dazu die Chat-Ansicht (`src/client.ts`): sie zeigt die Kopfzeile in der Owner-Blase mit
an und blendet sie nicht aus.
